...
window.addEventListener('load',()=>setTimeout(()=>{
 ...
 check('renderDisplayView adds no .is-wl highlight to stage people (.dv-sp)', ()=>{
   ...
   // Pin to a non-bespoke world (orbit) so this exercises the DEFAULT #dvLayout skeleton
   // it asserts against. The bespoke worlds (concrete=default, molten, corporate, terra) have their
   // own displays (.cw-*/.mw-*/.pw-*/.tw-*, no .dv-sp); orbit is the last fallback to the default skeleton.
