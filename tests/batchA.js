...
window.addEventListener('load',()=>setTimeout(()=>{
 ...
 check('renderDisplayView adds no .is-wl highlight to stage people (.dv-sp)', ()=>{
   ...
   // Pin to a non-bespoke world (terra) so this exercises the DEFAULT #dvLayout skeleton
   // it asserts against. The bespoke worlds (concrete=default, molten, corporate) have their own
   // displays (.cw-*/.mw-*/.pw-*, no .dv-sp); terra/orbit fall back to this default skeleton.
